...
describe("Check if merkle root is working", function() {
    it("Should be able to verify if a given address is in whitelist or not", async function () {
        ...
        // Create the Merkle Tree using the hashing algorithm `kecck256`
        // Make sure to sort the tree so that it can be produced deterministically regardless of the order of the input list
        ...
        // Compute the Merkle Proof of the owner address (0'th item in list) off-chain.
        // The leaf node is the hash of that value.
        ...
        let verified = await Whitelist.checkInWhiteList([], 2);
